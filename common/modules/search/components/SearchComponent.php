...
namespace common\modules\search\components;
...
class SearchComponent extends Component
{
    ...
    protected function createDocument($fields)
    {
        ...
        foreach ($fields as $field) {
            if (isset($field['type'])) {
                ...
                $currentType = SearchBehavior::FIELD_TEXT;
            }
    ...
    {
        $this->deleteFromIndex($fields);
        $this->add($fields);
    }

    public function deleteFromIndex($fields)
    {
        foreach ($fields as $field) {
            $this->delete($field['value'], $field['name']);
        }
    }
